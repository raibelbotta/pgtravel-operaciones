...
else{a=((n+i)/((100-t(r))/100))-(n+i)};o=n+i+a;e('#offer_form_grandTotal').val(o.toFixed(2));e('#offer_form_totalRevenue').val(a.toFixed(2))});e('#offer_form_totalSuppliers').trigger('change');e('#offer_form_percentApplied_percent').on('change',function(){if(e(this).val()!=='plus'){e('#offer_form_percentApplied_plus').val(0).attr('readonly','readonly')}
