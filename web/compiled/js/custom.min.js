...
;App=typeof App!=='undefined'?App:{};App.Contracts=typeof App.Contracts!=='undefined'?App.Contracts:{};+(App.Contracts.Index=function(e){var t=e('#datatable-x'),n=function(){t.dataTable({order:[[1,'asc']],columns:[{sortable:!1,searchable:!1},{name:'name'},{name:'model'},{name:'supplier'},{name:'signedAt'},{name:'startAt'},{name:'endAt'},{sortable:!1,searchable:!1,width:'80px'}],serverSide:!0,processing:!0,ajax:{method:'POST',url:Routing.generate('app_contracts_getdata'),data:function(t){var n=[];e.each(e('form#filter').serializeArray(),function(e,t){n[t['name']]=t['value']});return e.extend({},t,n)}}});t.on('draw.dt',function(){e(this).find('input').iCheck({'checkboxClass':'icheckbox_flat-green'})});t.on('click','a.btn-delete',function(n){n.preventDefault();var a=e(this).attr('href'),r=e(this);swal({title:Translator.trans('Confirm remove'),text:Translator.trans('The record will be removed. Are you sure you want to continue?'),type:'warning',showCancelButton:!0,confirmButtonColor:'#d9534f'},function(n){if(n){r.closest('td').text(Translator.trans('Removing...')).closest('tr').addClass('row-removing');e.ajax(a,{dataType:'json',method:'post',success:function(e){t.find('tr.row-removing').remove();t.dataTable().api().draw(!1)}})}})})},a=function(){e('#filter select').on('change',function(){t.DataTable().draw(!0)})};return{init:function(){n();a()}}}(jQuery));
...
;App=typeof App!=='undefined'?App:{};+(App.PrivateHousePrices=function(a){'use strict';var t=function(){a('body').on('change','input.updatable-ajax',function(){var t=a(this);if(t.data('saving')){t.data('saving').xhr.abort()};var e=a.now(),r=t.data('params'),o=r.split('|'),n={inputId:e,value:t.val()};a.each(o,function(a,e){var t=e.split(':');n[t[0]]=t[1]});t.css({borderColor:'red'}).attr({'ajax-id':e});var i={xhr:a.ajax(Routing.generate('app_contracts_setprivatehouseprice'),{data:n,dataType:'json',method:'POST',success:function(t){a('input:text.updatable-ajax[ajax-id='+t.inputId+']').val(t.value).css({borderColor:''}).removeAttr('ajax-id').removeData('saving')}})};t.data('saving',i)})};return{init:function(){t()}}}(jQuery));
